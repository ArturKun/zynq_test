...
#
# restore_project.tcl: Tcl script for re-creating project 'ZynqFifoStream'
#
# Generated by Vivado on Wed Jul 14 17:21:27 +0700 2021
...
#
#    "E:/ZYNQ/repo/zynqfifostream_project/zynqfifostream_sources/hdl/AdcClkBuf.v"
#    "E:/ZYNQ/repo/zynqfifostream_project/zynqfifostream_sources/hdl/CtrlFifoBufAdc.v"
#    "E:/ZYNQ/repo/zynqfifostream_project/zynqfifostream_sources/hdl/notRst.v"
#    "E:/ZYNQ/repo/zynqfifostream_project/zynqfifostream_sources/hdl/AdcInvertSignBit.v"
#    "E:/ZYNQ/repo/zynqfifostream_project/zynqfifostream_sources/bd/toplevel/toplevel.bd"
#    "E:/ZYNQ/repo/zynqfifostream_project/zynqfifostream_sources/bd/toplevel/hdl/toplevel_wrapper.v"
#    "E:/ZYNQ/repo/zynqfifostream_project/zynqfifostream_sources/constraints/constrain.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/zynqfifostream_sources/hdl/AdcClkBuf.v"]"\
 "[file normalize "$origin_dir/zynqfifostream_sources/hdl/CtrlFifoBufAdc.v"]"\
 "[file normalize "$origin_dir/zynqfifostream_sources/hdl/notRst.v"]"\
 "[file normalize "$origin_dir/zynqfifostream_sources/hdl/AdcInvertSignBit.v"]"\
 "[file normalize "$origin_dir/zynqfifostream_sources/bd/toplevel/toplevel.bd"]"\
 "[file normalize "$origin_dir/zynqfifostream_sources/bd/toplevel/hdl/toplevel_wrapper.v"]"\
 "[file normalize "$origin_dir/zynqfifostream_sources/constraints/constrain.xdc"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/zynqfifostream/[file normalize "$origin_dir/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "ZynqFifoStream"
...
set orig_proj_dir "[file normalize "$origin_dir/zynqfifostream"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../AppData/Roaming/Xilinx/Vivado/2019.1/xhub/board_store"]" -objects $obj
...
set file "$origin_dir/zynqfifostream_sources/hdl/AdcClkBuf.v"
...
set file "$origin_dir/zynqfifostream_sources/hdl/CtrlFifoBufAdc.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/zynqfifostream_sources/hdl/notRst.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/zynqfifostream_sources/hdl/AdcInvertSignBit.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/zynqfifostream_sources/bd/toplevel/toplevel.bd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/zynqfifostream_sources/bd/toplevel/hdl/toplevel_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "[file normalize "$origin_dir/zynqfifostream_sources/constraints/constrain.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/zynqfifostream_sources/constraints/constrain.xdc"
set file [file normalize $file]
...
set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/work/Xilinx/Vivado_2020/ZynqFifoStream/ZynqFifoStream.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "C:/Users/work/Xilinx/Vivado_2020/ZynqFifoStream/ZynqFifoStream.srcs/utils_1/imports/impl_1" -objects $obj
